...
import { useCategories } from '@/pages/Books/hooks/useCategories';
...
export default function Navbar() {
  ...
  // Use API categories if loaded, otherwise fallback to mock data
  const categories = categoriesLoading ? mockCategories : apiCategories;
